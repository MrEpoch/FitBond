...
CREATE TABLE IF NOT EXISTS "food" (
	...
	"user_health_id" uuid,
	"calories_100g" text NOT NULL,
	"protein_100g" text NOT NULL,
	"fibers_100g" text NOT NULL,
	"carbohydrates_100g" text NOT NULL,
	"salt_100g" text NOT NULL,
	"sugar_100g" text NOT NULL,
	"fats_100g" text NOT NULL,
	"fats_sat_100g" text NOT NULL,
	"fats_mono_100g" text NOT NULL,
	"fats_poly_100g" text NOT NULL,
	"fats_trans_100g" text NOT NULL,
	"created_at" timestamp with time zone,
